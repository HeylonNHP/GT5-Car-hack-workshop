	...
	internal sealed class MyProject
	{
		...
		internal sealed class MyForms
		{
			...
			public Customperformance Customperformance
			{
				get
				{
					this.m_Customperformance = MyProject.MyForms.Create__Instance__<Customperformance>(this.m_Customperformance);
					return this.m_Customperformance;
				}
				set
				{
					if (value == this.m_Customperformance)
					{
						return;
					}
					if (value != null)
					...
					this.Dispose__Instance__<Customperformance>(ref this.m_Customperformance);
				}
			}
			...
			public Tranny Tranny
			{
				get
				{
					this.m_Tranny = MyProject.MyForms.Create__Instance__<Tranny>(this.m_Tranny);
					return this.m_Tranny;
				}
				set
				{
					if (value == this.m_Tranny)
					{
						return;
					}
					if (value != null)
					...
					this.Dispose__Instance__<Tranny>(ref this.m_Tranny);
				}
			}
			...
			private static T Create__Instance__<T>(T Instance) where T : Form, new()
			{
				if (Instance == null || Instance.IsDisposed)
				{
					...
					{
						string BetterMessage = Utils.GetResourceString("WinForms_SeeInnerException", new string[] { ex.InnerException.Message });
